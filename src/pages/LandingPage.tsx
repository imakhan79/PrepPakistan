...
const FEATURES = [
  { icon: <Sparkles className="h-5 w-5" />, title: 'AI-Powered Study Plans', desc: 'Personalized, adaptive plans that evolve with your progress.' },
    ...
    <div className="min-h-screen bg-gradient-to-b from-brand-50 via-white to-white">
      ...
      <section className="mx-auto max-w-4xl px-6 pb-16 pt-12 text-center sm:pt-20">
        <span className="inline-flex items-center gap-1.5 rounded-full bg-accent-50 px-3 py-1 text-xs font-semibold text-accent-700">
          <Sparkles className="h-3.5 w-3.5" /> AI-powered learning, built for Pakistan
        </span>
        ...
        <p className="mx-auto mt-5 max-w-2xl text-lg text-slate-600">
          Personalized study plans, adaptive practice, and mock exams that help you master every subject —
